...
import static net.zeeraa.mochadoom.data.Defines.ANGLETOSKYSHIFT;
import static net.zeeraa.mochadoom.data.Defines.NF_SUBSECTOR;
import static net.zeeraa.mochadoom.data.Defines.PU_CACHE;
import static net.zeeraa.mochadoom.data.Defines.SIL_BOTH;
import static net.zeeraa.mochadoom.data.Defines.SIL_BOTTOM;
import static net.zeeraa.mochadoom.data.Defines.SIL_TOP;
import static net.zeeraa.mochadoom.data.Limits.MAXHEIGHT;
import static net.zeeraa.mochadoom.data.Limits.MAXSEGS;
import static net.zeeraa.mochadoom.data.Limits.MAXWIDTH;
import static net.zeeraa.mochadoom.data.Tables.ANG180;
import static net.zeeraa.mochadoom.data.Tables.ANG270;
import static net.zeeraa.mochadoom.data.Tables.ANG90;
import static net.zeeraa.mochadoom.data.Tables.ANGLETOFINESHIFT;
import static net.zeeraa.mochadoom.data.Tables.BITS32;
import static net.zeeraa.mochadoom.data.Tables.DBITS;
import static net.zeeraa.mochadoom.data.Tables.FINEANGLES;
import static net.zeeraa.mochadoom.data.Tables.QUARTERMARK;
import static net.zeeraa.mochadoom.data.Tables.SlopeDiv;
import static net.zeeraa.mochadoom.data.Tables.addAngles;
import static net.zeeraa.mochadoom.data.Tables.finecosine;
import static net.zeeraa.mochadoom.data.Tables.finesine;
import static net.zeeraa.mochadoom.data.Tables.finetangent;
import static net.zeeraa.mochadoom.data.Tables.tantoangle;
import static net.zeeraa.mochadoom.doom.SourceCode.R_Draw.R_FillBackScreen;
import static net.zeeraa.mochadoom.m.BBox.BOXBOTTOM;
import static net.zeeraa.mochadoom.m.BBox.BOXLEFT;
import static net.zeeraa.mochadoom.m.BBox.BOXRIGHT;
import static net.zeeraa.mochadoom.m.BBox.BOXTOP;
import static net.zeeraa.mochadoom.m.fixed_t.FRACBITS;
import static net.zeeraa.mochadoom.m.fixed_t.FRACUNIT;
import static net.zeeraa.mochadoom.m.fixed_t.FixedDiv;
import static net.zeeraa.mochadoom.m.fixed_t.FixedMul;
import static net.zeeraa.mochadoom.p.ActiveStates.P_MobjThinker;
import static net.zeeraa.mochadoom.rr.line_t.*;
import static net.zeeraa.mochadoom.utils.GenericCopy.malloc;
import static net.zeeraa.mochadoom.v.DoomGraphicSystem.V_NOSCALEOFFSET;
import static net.zeeraa.mochadoom.v.DoomGraphicSystem.V_NOSCALEPATCH;
import static net.zeeraa.mochadoom.v.DoomGraphicSystem.V_NOSCALESTART;
...
import net.zeeraa.mochadoom.data.Defines;
...
import net.zeeraa.mochadoom.rr.drawfuns.DoomColumnFunction;
import net.zeeraa.mochadoom.rr.drawfuns.DoomSpanFunction;
import net.zeeraa.mochadoom.rr.drawfuns.SpanVars;
import net.zeeraa.mochadoom.utils.C2JUtils;
import net.zeeraa.mochadoom.v.graphics.Palettes;
import net.zeeraa.mochadoom.v.renderers.DoomScreen;
import net.zeeraa.mochadoom.v.tables.BlurryTable;
