...
import static net.zeeraa.mochadoom.data.Defines.FF_FULLBRIGHT;
import static net.zeeraa.mochadoom.data.Defines.pw_invisibility;
import static net.zeeraa.mochadoom.m.fixed_t.*;
import static net.zeeraa.mochadoom.p.mobj_t.MF_TRANSLATION;
...
import net.zeeraa.mochadoom.rr.AbstractThings;
import net.zeeraa.mochadoom.rr.IDetailAware;
import net.zeeraa.mochadoom.rr.SceneRenderer;
import net.zeeraa.mochadoom.rr.column_t;
import net.zeeraa.mochadoom.rr.drawseg_t;
...
import net.zeeraa.mochadoom.rr.vissprite_t;
import net.zeeraa.mochadoom.rr.drawfuns.ColFuncs;
import net.zeeraa.mochadoom.rr.drawfuns.ColVars;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawColumnBoom;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawColumnBoomLow;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawFuzzColumn;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawFuzzColumnLow;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawTranslatedColumn;
import net.zeeraa.mochadoom.rr.drawfuns.R_DrawTranslatedColumnLow;
