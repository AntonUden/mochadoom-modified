 ...
 */
package net.zeeraa.mochadoom.v.tables;

import static net.zeeraa.mochadoom.v.graphics.Lights.COLORMAP_BLURRY;
import static net.zeeraa.mochadoom.v.graphics.Lights.COLORMAP_FIXED;
import static net.zeeraa.mochadoom.v.graphics.Palettes.*;

import java.util.TreeMap;

import net.zeeraa.mochadoom.Engine;
import net.zeeraa.mochadoom.m.Settings;
import net.zeeraa.mochadoom.v.graphics.Colors;
