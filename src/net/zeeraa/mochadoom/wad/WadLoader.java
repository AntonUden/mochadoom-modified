...
package net.zeeraa.mochadoom.wad;

import static net.zeeraa.mochadoom.data.Defines.PU_CACHE;
import static net.zeeraa.mochadoom.doom.SourceCode.W_Wad.W_CacheLumpName;
import static net.zeeraa.mochadoom.doom.SourceCode.W_Wad.W_CheckNumForName;
...
import net.zeeraa.mochadoom.doom.SourceCode.W_Wad;
import net.zeeraa.mochadoom.i.DummySystem;
		...
		if ((lumpcache[lump] == null)||(what==null)) {
			...
			if (what != null) {
				try {
					...
					if (implementsInterface(what, net.zeeraa.mochadoom.wad.CacheableDoomObject.class)) {
