...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Spec.P_SpawnSpecials;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Tick.P_RemoveThinker;
import static net.zeeraa.mochadoom.m.fixed_t.FRACBITS;
import static net.zeeraa.mochadoom.p.ActiveStates.NOP;
import static net.zeeraa.mochadoom.p.DoorDefines.FASTDARK;
import static net.zeeraa.mochadoom.p.DoorDefines.SLOWDARK;
...
import net.zeeraa.mochadoom.doom.SourceCode.P_Spec;
import net.zeeraa.mochadoom.p.*;
import net.zeeraa.mochadoom.p.ActiveStates.MobjConsumer;
import net.zeeraa.mochadoom.p.ActiveStates.ThinkerConsumer;
