...
import static net.zeeraa.mochadoom.data.Limits.MAXSPECIALCROSS;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PIT_CheckLine;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.P_CheckPosition;
import static net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl.P_BlockLinesIterator;
import static net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl.P_BlockThingsIterator;
...
import static net.zeeraa.mochadoom.p.AbstractLevelLoader.FIX_BLOCKMAP_512;
import static net.zeeraa.mochadoom.p.mobj_t.MF_MISSILE;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOCLIP;
import static net.zeeraa.mochadoom.rr.line_t.ML_BLOCKING;
import static net.zeeraa.mochadoom.rr.line_t.ML_BLOCKMONSTERS;
...
import net.zeeraa.mochadoom.p.UnifiedGameMap;
...
import net.zeeraa.mochadoom.utils.TraitFactory.Trait;
