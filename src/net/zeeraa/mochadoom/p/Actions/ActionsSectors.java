...
import static net.zeeraa.mochadoom.data.Defines.MELEERANGE;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PIT_ChangeSector;
...
import static net.zeeraa.mochadoom.p.mobj_t.MF_DROPPED;
...
import net.zeeraa.mochadoom.p.divline_t;
import net.zeeraa.mochadoom.p.floor_e;
import net.zeeraa.mochadoom.p.floormove_t;
import net.zeeraa.mochadoom.p.mobj_t;
import net.zeeraa.mochadoom.p.result_e;
