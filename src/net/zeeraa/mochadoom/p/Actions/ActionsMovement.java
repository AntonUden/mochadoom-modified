 ...
 */
package net.zeeraa.mochadoom.p.Actions;

import static net.zeeraa.mochadoom.data.Defines.FLOATSPEED;
import static net.zeeraa.mochadoom.data.Defines.PT_ADDLINES;
import static net.zeeraa.mochadoom.data.Limits.MAXMOVE;
...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PTR_SlideTraverse;
import static net.zeeraa.mochadoom.m.fixed_t.FRACUNIT;
import static net.zeeraa.mochadoom.m.fixed_t.FixedMul;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_EAST;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_NODIR;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_NORTH;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_SOUTH;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_SOUTHEAST;
import static net.zeeraa.mochadoom.p.ChaseDirections.DI_WEST;
import static net.zeeraa.mochadoom.p.ChaseDirections.diags;
import static net.zeeraa.mochadoom.p.ChaseDirections.opposite;
import static net.zeeraa.mochadoom.p.ChaseDirections.xspeed;
import static net.zeeraa.mochadoom.p.ChaseDirections.yspeed;
import static net.zeeraa.mochadoom.p.MapUtils.AproxDistance;
import static net.zeeraa.mochadoom.p.mobj_t.MF_CORPSE;
import static net.zeeraa.mochadoom.p.mobj_t.MF_DROPOFF;
import static net.zeeraa.mochadoom.p.mobj_t.MF_FLOAT;
import static net.zeeraa.mochadoom.p.mobj_t.MF_INFLOAT;
import static net.zeeraa.mochadoom.p.mobj_t.MF_MISSILE;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOCLIP;
import static net.zeeraa.mochadoom.p.mobj_t.MF_SKULLFLY;
import static net.zeeraa.mochadoom.p.mobj_t.MF_TELEPORT;
import static net.zeeraa.mochadoom.rr.line_t.ML_TWOSIDED;
import static net.zeeraa.mochadoom.utils.C2JUtils.eval;

import net.zeeraa.mochadoom.defines.slopetype_t;
import net.zeeraa.mochadoom.defines.statenum_t;
import net.zeeraa.mochadoom.doom.SourceCode;
import net.zeeraa.mochadoom.doom.player_t;
import net.zeeraa.mochadoom.doom.SourceCode.fixed_t;
import net.zeeraa.mochadoom.p.intercept_t;
import net.zeeraa.mochadoom.p.mobj_t;
import net.zeeraa.mochadoom.rr.SceneRenderer;
import net.zeeraa.mochadoom.rr.line_t;
import net.zeeraa.mochadoom.utils.TraitFactory.ContextKey;
