...
import static net.zeeraa.mochadoom.data.Defines.MISSILERANGE;
import static net.zeeraa.mochadoom.data.Defines.PT_ADDLINES;
import static net.zeeraa.mochadoom.data.Defines.PT_ADDTHINGS;
import static net.zeeraa.mochadoom.data.Limits.MAXRADIUS;
...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Enemy.PIT_VileCheck;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PIT_RadiusAttack;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PTR_ShootTraverse;
...
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOBLOOD;
...
import net.zeeraa.mochadoom.doom.SourceCode.P_Enemy;
import net.zeeraa.mochadoom.doom.SourceCode.P_Map;
import net.zeeraa.mochadoom.doom.SourceCode.angle_t;
