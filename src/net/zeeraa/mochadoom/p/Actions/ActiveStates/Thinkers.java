...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.T_FireFlicker;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.T_Glow;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.T_LightFlash;
import static net.zeeraa.mochadoom.p.DoorDefines.GLOWSPEED;
...
import net.zeeraa.mochadoom.p.ceiling_t;
import net.zeeraa.mochadoom.p.floormove_t;
import net.zeeraa.mochadoom.p.plat_t;
import net.zeeraa.mochadoom.p.slidedoor_t;
...
import net.zeeraa.mochadoom.p.Actions.ActionsLights.fireflicker_t;
