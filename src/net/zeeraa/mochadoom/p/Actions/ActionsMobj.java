...
import static net.zeeraa.mochadoom.data.Defines.BASETHRESHOLD;
import static net.zeeraa.mochadoom.data.Defines.ITEMQUESIZE;
import static net.zeeraa.mochadoom.data.Defines.ONFLOORZ;
import static net.zeeraa.mochadoom.data.Defines.PST_DEAD;
import static net.zeeraa.mochadoom.data.Defines.pw_invulnerability;
...
import static net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl.P_UnsetThingPosition;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Mobj.P_RemoveMobj;
...
import static net.zeeraa.mochadoom.p.MobjFlags.MF_DROPPED;
import static net.zeeraa.mochadoom.p.MobjFlags.MF_NOBLOCKMAP;
import static net.zeeraa.mochadoom.p.MobjFlags.MF_NOSECTOR;
import static net.zeeraa.mochadoom.p.MobjFlags.MF_SPECIAL;
import static net.zeeraa.mochadoom.p.mobj_t.MF_CORPSE;
import static net.zeeraa.mochadoom.p.mobj_t.MF_COUNTKILL;
import static net.zeeraa.mochadoom.p.mobj_t.MF_DROPOFF;
import static net.zeeraa.mochadoom.p.mobj_t.MF_FLOAT;
import static net.zeeraa.mochadoom.p.mobj_t.MF_JUSTHIT;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOCLIP;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOGRAVITY;
import static net.zeeraa.mochadoom.p.mobj_t.MF_SHOOTABLE;
import static net.zeeraa.mochadoom.p.mobj_t.MF_SKULLFLY;
import static net.zeeraa.mochadoom.p.mobj_t.MF_SOLID;
...
import net.zeeraa.mochadoom.doom.weapontype_t;
import net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl;
