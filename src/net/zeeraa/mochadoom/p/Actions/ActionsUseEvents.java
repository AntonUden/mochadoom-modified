...
import static net.zeeraa.mochadoom.data.Defines.USERANGE;
import static net.zeeraa.mochadoom.data.Tables.finecosine;
import static net.zeeraa.mochadoom.data.Tables.finesine;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Map.PTR_UseTraverse;
import static net.zeeraa.mochadoom.m.fixed_t.FRACBITS;
import static net.zeeraa.mochadoom.rr.line_t.ML_SECRET;
...
import net.zeeraa.mochadoom.p.ceiling_e;
import net.zeeraa.mochadoom.p.floor_e;
import net.zeeraa.mochadoom.p.intercept_t;
import net.zeeraa.mochadoom.p.mobj_t;
import net.zeeraa.mochadoom.p.plattype_e;
import net.zeeraa.mochadoom.p.stair_e;
