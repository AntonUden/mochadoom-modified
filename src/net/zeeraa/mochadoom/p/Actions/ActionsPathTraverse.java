...
import static net.zeeraa.mochadoom.data.Defines.MAPBLOCKSHIFT;
import static net.zeeraa.mochadoom.data.Defines.MAPBLOCKSIZE;
import static net.zeeraa.mochadoom.data.Defines.MAPBTOFRAC;
import static net.zeeraa.mochadoom.data.Defines.PT_ADDLINES;
import static net.zeeraa.mochadoom.data.Defines.PT_ADDTHINGS;
import static net.zeeraa.mochadoom.data.Defines.PT_EARLYOUT;
import static net.zeeraa.mochadoom.data.Limits.MAXINT;
import static net.zeeraa.mochadoom.data.Limits.MAXINTERCEPTS;
import static net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl.P_PathTraverse;
...
import static net.zeeraa.mochadoom.p.MapUtils.InterceptVector;
