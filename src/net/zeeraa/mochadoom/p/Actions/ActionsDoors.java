...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Doors.P_SpawnDoorCloseIn30;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Doors.P_SpawnDoorRaiseIn5Mins;
import static net.zeeraa.mochadoom.doom.englsh.PD_BLUEK;
import static net.zeeraa.mochadoom.doom.englsh.PD_BLUEO;
import static net.zeeraa.mochadoom.doom.englsh.PD_REDK;
import static net.zeeraa.mochadoom.doom.englsh.PD_REDO;
import static net.zeeraa.mochadoom.doom.englsh.PD_YELLOWK;
import static net.zeeraa.mochadoom.doom.englsh.PD_YELLOWO;
import static net.zeeraa.mochadoom.m.fixed_t.FRACUNIT;
import static net.zeeraa.mochadoom.p.ActiveStates.T_VerticalDoor;
import static net.zeeraa.mochadoom.p.DoorDefines.VDOORSPEED;
import static net.zeeraa.mochadoom.p.DoorDefines.VDOORWAIT;
import static net.zeeraa.mochadoom.utils.C2JUtils.eval;

import net.zeeraa.mochadoom.data.sounds;
import net.zeeraa.mochadoom.defines.card_t;
...
import net.zeeraa.mochadoom.doom.SourceCode.P_Doors;
import net.zeeraa.mochadoom.p.ActiveStates;
import net.zeeraa.mochadoom.p.mobj_t;
import net.zeeraa.mochadoom.p.plat_t;
import net.zeeraa.mochadoom.p.result_e;
import net.zeeraa.mochadoom.p.vldoor_e;
import net.zeeraa.mochadoom.p.vldoor_t;
