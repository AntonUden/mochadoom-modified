...
import static net.zeeraa.mochadoom.data.Defines.MTF_AMBUSH;
import static net.zeeraa.mochadoom.data.Defines.NUMCARDS;
import static net.zeeraa.mochadoom.data.Defines.ONCEILINGZ;
import static net.zeeraa.mochadoom.data.Defines.ONFLOORZ;
import static net.zeeraa.mochadoom.data.Defines.PST_LIVE;
import static net.zeeraa.mochadoom.data.Defines.PST_REBORN;
import static net.zeeraa.mochadoom.data.Defines.VIEWHEIGHT;
import static net.zeeraa.mochadoom.data.Limits.MAXPLAYERS;
import static net.zeeraa.mochadoom.data.Limits.NUMMOBJTYPES;
import static net.zeeraa.mochadoom.data.Tables.ANG45;
import static net.zeeraa.mochadoom.data.info.mobjinfo;
import static net.zeeraa.mochadoom.data.info.states;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Mobj.P_SpawnMobj;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Mobj.P_SpawnPlayer;
import static net.zeeraa.mochadoom.m.fixed_t.FRACBITS;
import static net.zeeraa.mochadoom.m.fixed_t.FRACUNIT;
import static net.zeeraa.mochadoom.p.mobj_t.MF_AMBUSH;
import static net.zeeraa.mochadoom.p.mobj_t.MF_COUNTITEM;
import static net.zeeraa.mochadoom.p.mobj_t.MF_COUNTKILL;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOTDMATCH;
import static net.zeeraa.mochadoom.p.mobj_t.MF_SPAWNCEILING;
import static net.zeeraa.mochadoom.p.mobj_t.MF_TRANSSHIFT;
import static net.zeeraa.mochadoom.utils.C2JUtils.eval;

import java.util.logging.Level;

import net.zeeraa.mochadoom.data.mapthing_t;
import net.zeeraa.mochadoom.data.mobjinfo_t;
import net.zeeraa.mochadoom.data.mobjtype_t;
import net.zeeraa.mochadoom.data.sounds;
import net.zeeraa.mochadoom.data.state_t;
...
import net.zeeraa.mochadoom.doom.SourceCode.P_Mobj;
import net.zeeraa.mochadoom.doom.SourceCode.fixed_t;
import net.zeeraa.mochadoom.p.ActiveStates;
