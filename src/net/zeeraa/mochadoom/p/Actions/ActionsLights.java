...
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.P_SpawnFireFlicker;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.P_SpawnGlowingLight;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.P_SpawnLightFlash;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Lights.P_SpawnStrobeFlash;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Spec.P_FindMinSurroundingLight;
import static net.zeeraa.mochadoom.p.ActiveStates.T_FireFlicker;
import static net.zeeraa.mochadoom.p.ActiveStates.T_Glow;
import static net.zeeraa.mochadoom.p.ActiveStates.T_LightFlash;
import static net.zeeraa.mochadoom.p.ActiveStates.T_StrobeFlash;
import static net.zeeraa.mochadoom.p.DoorDefines.SLOWDARK;
import static net.zeeraa.mochadoom.p.DoorDefines.STROBEBRIGHT;
