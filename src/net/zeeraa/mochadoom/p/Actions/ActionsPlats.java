...
import static net.zeeraa.mochadoom.data.Limits.MAXPLATS;
import static net.zeeraa.mochadoom.data.Limits.PLATSPEED;
import static net.zeeraa.mochadoom.data.Limits.PLATWAIT;
import static net.zeeraa.mochadoom.m.fixed_t.FRACUNIT;
import static net.zeeraa.mochadoom.p.ActiveStates.NOP;
import static net.zeeraa.mochadoom.p.ActiveStates.T_PlatRaise;
