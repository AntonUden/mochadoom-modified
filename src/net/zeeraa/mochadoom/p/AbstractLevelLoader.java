...
import static net.zeeraa.mochadoom.data.Defines.BLOCKMAPPADDING;
import static net.zeeraa.mochadoom.data.Defines.MAPBLOCKSHIFT;
import static net.zeeraa.mochadoom.data.Defines.MAPBLOCKUNITS;
import static net.zeeraa.mochadoom.data.Defines.NF_SUBSECTOR;
import static net.zeeraa.mochadoom.data.Defines.PU_LEVEL;
import static net.zeeraa.mochadoom.doom.SourceCode.P_MapUtl.P_SetThingPosition;
import static net.zeeraa.mochadoom.doom.SourceCode.R_Main.*;
import static net.zeeraa.mochadoom.m.fixed_t.FRACBITS;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOBLOCKMAP;
import static net.zeeraa.mochadoom.p.mobj_t.MF_NOSECTOR;
...
import net.zeeraa.mochadoom.doom.SourceCode.R_Main;
