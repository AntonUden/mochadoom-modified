...
package net.zeeraa.mochadoom;

import static net.zeeraa.mochadoom.awt.EventBase.KeyStateSatisfaction.*;
...
import net.zeeraa.mochadoom.awt.DoomWindow;
import net.zeeraa.mochadoom.awt.DoomWindowController;
import net.zeeraa.mochadoom.awt.EventHandler;
import net.zeeraa.mochadoom.awt.EventBase.KeyStateInterest;
...
public class Engine {
    ...
    public Engine(JFrame jframe, final String... argv) throws IOException {
        instance = this;
