...
import static net.zeeraa.mochadoom.doom.ConfigBase.FILE_DOOM;
import static net.zeeraa.mochadoom.doom.ConfigBase.FILE_MOCHADOOM;
...
import net.zeeraa.mochadoom.awt.FullscreenOptions;
import net.zeeraa.mochadoom.doom.ConfigManager;
import net.zeeraa.mochadoom.doom.ConfigBase.Files;
import net.zeeraa.mochadoom.utils.QuoteType;
import net.zeeraa.mochadoom.v.graphics.Plotter;
import net.zeeraa.mochadoom.v.renderers.BppMode;
import net.zeeraa.mochadoom.v.renderers.SceneRendererMode;
import net.zeeraa.mochadoom.v.tables.GreyscaleFilter;
