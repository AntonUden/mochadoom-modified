...
import static net.zeeraa.mochadoom.data.Defines.HU_FONTSIZE;
import static net.zeeraa.mochadoom.data.Defines.HU_FONTSTART;
import static net.zeeraa.mochadoom.data.Defines.PU_CACHE;
import static net.zeeraa.mochadoom.data.Defines.SAVESTRINGSIZE;
import static net.zeeraa.mochadoom.data.dstrings.NUM_QUITMESSAGES;
import static net.zeeraa.mochadoom.data.dstrings.SAVEGAMENAME;
import static net.zeeraa.mochadoom.data.dstrings.endmsg;
import static net.zeeraa.mochadoom.doom.SourceCode.M_Menu.M_Responder;
import static net.zeeraa.mochadoom.doom.SourceCode.M_Menu.M_StartControlPanel;
import static net.zeeraa.mochadoom.doom.SourceCode.M_Menu.M_Ticker;
import static net.zeeraa.mochadoom.doom.englsh.DOSY;
import static net.zeeraa.mochadoom.doom.englsh.EMPTYSTRING;
import static net.zeeraa.mochadoom.doom.englsh.ENDGAME;
import static net.zeeraa.mochadoom.doom.englsh.GAMMALVL0;
import static net.zeeraa.mochadoom.doom.englsh.GAMMALVL1;
import static net.zeeraa.mochadoom.doom.englsh.GAMMALVL2;
import static net.zeeraa.mochadoom.doom.englsh.GAMMALVL3;
import static net.zeeraa.mochadoom.doom.englsh.GAMMALVL4;
import static net.zeeraa.mochadoom.doom.englsh.LOADNET;
import static net.zeeraa.mochadoom.doom.englsh.MSGOFF;
import static net.zeeraa.mochadoom.doom.englsh.MSGON;
import static net.zeeraa.mochadoom.doom.englsh.NETEND;
import static net.zeeraa.mochadoom.doom.englsh.NEWGAME;
import static net.zeeraa.mochadoom.doom.englsh.NIGHTMARE;
import static net.zeeraa.mochadoom.doom.englsh.QLOADNET;
import static net.zeeraa.mochadoom.doom.englsh.QLPROMPT;
import static net.zeeraa.mochadoom.doom.englsh.QSAVESPOT;
import static net.zeeraa.mochadoom.doom.englsh.QSPROMPT;
import static net.zeeraa.mochadoom.doom.englsh.SAVEDEAD;
import static net.zeeraa.mochadoom.doom.englsh.SWSTRING;
...
import net.zeeraa.mochadoom.doom.englsh;
import net.zeeraa.mochadoom.doom.event_t;
import net.zeeraa.mochadoom.doom.evtype_t;
import net.zeeraa.mochadoom.doom.SourceCode.M_Menu;
import net.zeeraa.mochadoom.g.Signals.ScanCode;
import net.zeeraa.mochadoom.rr.patch_t;
import net.zeeraa.mochadoom.timing.DelegateTicker;
import net.zeeraa.mochadoom.utils.C2JUtils;
import net.zeeraa.mochadoom.wad.DoomIO;
