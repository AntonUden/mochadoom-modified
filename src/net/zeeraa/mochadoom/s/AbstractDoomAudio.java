package net.zeeraa.mochadoom.s;
...
import static net.zeeraa.mochadoom.data.sounds.S_sfx;
...
import net.zeeraa.mochadoom.data.musicinfo_t;
...
public class AbstractDoomAudio implements IDoomSound{
			...
			vps_t vps)
	{
		...
		angle = net.zeeraa.mochadoom.rr.RendererState.PointToAngle(listener.x,
				listener.y,
				source.getX(),
				source.getY());
