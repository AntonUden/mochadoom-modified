...
import static net.zeeraa.mochadoom.data.info.*;
import static net.zeeraa.mochadoom.doom.SourceCode.G_Game.*;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Pspr.P_BringUpWeapon;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Pspr.P_SetPsprite;
import static net.zeeraa.mochadoom.doom.SourceCode.P_Pspr.P_SetupPsprites;
import static net.zeeraa.mochadoom.doom.items.weaponinfo;
import static net.zeeraa.mochadoom.m.fixed_t.*;
import static net.zeeraa.mochadoom.p.mobj_t.*;
...
import net.zeeraa.mochadoom.doom.SourceCode.P_Pspr;
import net.zeeraa.mochadoom.p.mobj_t;
import net.zeeraa.mochadoom.p.pspdef_t;
import net.zeeraa.mochadoom.p.ActiveStates.PlayerSpriteConsumer;
...
import net.zeeraa.mochadoom.wad.IPackableDoomObject;
import net.zeeraa.mochadoom.wad.IReadableDoomObject;
