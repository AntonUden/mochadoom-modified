...
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_Start;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_initAnimatedBack;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_initDeathmatchStats;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_initNetgameStats;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_initStats;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_initVariables;
import static net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff.WI_loadData;
...
import net.zeeraa.mochadoom.doom.wbplayerstruct_t;
import net.zeeraa.mochadoom.doom.wbstartstruct_t;
import net.zeeraa.mochadoom.doom.SourceCode.CauseOfDesyncProbability;
import net.zeeraa.mochadoom.doom.SourceCode.WI_Stuff;
import net.zeeraa.mochadoom.rr.*;
