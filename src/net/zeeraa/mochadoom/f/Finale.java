package net.zeeraa.mochadoom.f;

import static net.zeeraa.mochadoom.data.Defines.FF_FRAMEMASK;
...
import static net.zeeraa.mochadoom.data.Defines.PU_LEVEL;
...
import static net.zeeraa.mochadoom.doom.SourceCode.F_Finale.F_Responder;
import static net.zeeraa.mochadoom.doom.englsh.*;
import static net.zeeraa.mochadoom.utils.C2JUtils.*;
import static net.zeeraa.mochadoom.v.DoomGraphicSystem.*;
...
import net.zeeraa.mochadoom.doom.gameaction_t;
import net.zeeraa.mochadoom.doom.SourceCode.F_Finale;
import net.zeeraa.mochadoom.m.Settings;
import net.zeeraa.mochadoom.rr.flat_t;
import net.zeeraa.mochadoom.rr.patch_t;
import net.zeeraa.mochadoom.rr.spritedef_t;
import net.zeeraa.mochadoom.rr.spriteframe_t;
import net.zeeraa.mochadoom.v.graphics.Blocks;
