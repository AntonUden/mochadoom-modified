...
import static net.zeeraa.mochadoom.data.Defines.VERSION;
import static net.zeeraa.mochadoom.data.Limits.MAXPLAYERS;
import static net.zeeraa.mochadoom.data.Limits.SAVESTRINGSIZE;
import static net.zeeraa.mochadoom.data.Limits.VERSIONSIZE;
